    ...
    <div class="section_title mb-20px mt-5 ">
        ...
        <!-- booking form -->
            <div class="col-lg-6 p-3">
                ...
                <p>To Get Customize Trip Or Query Related To Package.<br> Contact Us Or Fill Up Form Details .<br>Will Get Back To You Soon!</p>
                <div class="row mt-5">
                    <div class="col-lg-12">
                        <h5><i style="width:60px" class="fa fa-envelope"></i> Email : holidaybunch@email.com</h5><hr>
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-12">
                        <h5><i style="width:60px" class="fa fa-phone"></i> Contact : 9876543210</h5><hr>
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-12">              
                        <h5><i style="width:60px" class="fa fa-address-card"></i> Mahim,Mumbai 400018</h5><hr>
                    </div>
                </div>
            ...
            <div class="col-lg-6 p-3">
                <form action="">
                    ...
                    <textarea name="" id="" class="form-control" cols="30" rows="4" placeholder="Type Your Message ..." required></textarea><br>
                    <input type="submit" name="submit" value="SUBMIT" id="" class="form-control btn book_now" placeholder="Submit" required><br>
                </form>
            </div>
