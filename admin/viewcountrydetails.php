    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper" style="background-color:white">
          <h3 class="text-center mb-5">Packages Details</h3>
            <div class="row">
                
                <?php
                  $country=$_GET['country'];
                  $sql="select * from package where country='$country'";
                  ...
                  while($row=mysqli_fetch_array($query))
                  {
                    ...
                    <div class="col-lg-4">
                      <div class="card p-3">
                      <h4>'.$row['name'].'</h4>
                      <img src="uploads/package/'.$row['image'].'" style="height:180px"><br>
                      <h5>Price = '.$row['price'].' ₹</h5>
                      <h5>Days = '.$row['days'].' &nbsp;&nbsp;  Nights ='.$row['nights'].'</h5>
                      </div>
                    </div>
