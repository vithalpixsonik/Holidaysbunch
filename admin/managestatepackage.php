    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper" style="background-color:white">
          ...
          <form action="managestatepackage.php" class="d-flex justify-content-center" style="width:100%" method="POST">
            <div class="row">
              <div class="col-lg-12">
              <h4 class="text-center mb-3">Search Package Details</h4>
                <div class="row">
                  <div class="col-lg-8">
                    <select style="width:350px;height:40px;border:1px solid #ececed" name="country_name" id="">
                      <option value="">Select Destination From Below...</option>
                      <?php 
                  ...
                  <div class="col-lg-4">
                    <input type="submit" name="search" class="btn btn-primary"  value="Search packages">
                  </div>
                </div>
              ...
              ?>
                <tr>
                  ...
                  echo '
                    ...
                    <a href="deletestatepackage.php?id='.$row['id'].'"><button class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
                  ';
                  ?></td>
                </tr>
              <?php } ?>
