...
<button class="tablink" onclick="openPage('Incl', this)" id="inclusion">Inclusions & Exclusions</button>
          ...
          <form action="addstatepackage.php" method="POST" enctype="multipart/form-data"  class="mt-4 mb-5">
            <div class="row">
              <div class="col-lg-2">
            ...
            <div class="row">
              <div class="col-lg-6">
                    <div class="form-group">
                      <label for="country">Destination</label><br>
              ...
              <div class="col-lg-6">
                    <div class="form-group">
                      <label for="package-image">Package Image (800 X 400 px)</label>
                      <input type="file" name="featured_image" class="form-control" style="border: 1px solid #b9b9b9;border-radius: 0">
                    </div>
              </div>
      ...
      $("#inclusion").addClass('clicked');
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2019 HolidaysBunch. All rights reserved.</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
