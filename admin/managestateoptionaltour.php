      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row card" style="margin-left: 5%;margin-right: 5%"> 
            <h4 class="text-center p-4">Manage Optional Tour</h4>
            <table class="table table-bordered">
                <thead>
                    ...
                    <th scope="col">Optional Tours Details</th>
                    </tr>
                </thead>
                <tbody>
                   ...
                   <?php 
                        echo '<td><a href="viewoptionaldetails.php?country='.$row['name'].'">View Details</a>
                        </td>';
            ...
            <?php 
              ...
              {
              $id=$_GET['name'];
              $sql1="delete from country where id='$id'";
              $query1=mysqli_query($con,$sql1);
              if($query1)
              {
                echo '<div class="container alert alert-success mt-3" role="alert">
                Optional Tour Has Been Deleted Successfully!
              </div>';
              }
              }
            ?>
