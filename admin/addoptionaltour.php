...
<body>
 ...
 <!--################## Additional Tour ##################-->
          ...
          <div id="Additional" class="tabcontent" >
            ...
            <form action="addoptionaltour.php" method="POST" enctype="multipart/form-data"  class="mt-4 mb-5">
                  <div class="row">
                    <div class="col-lg-6">
                          <div class="form-group">
                            <label for="id">Country</label><br>
                            <select name="country" class="select-border" style="width:100%;height:40px;border:1px solid #ececed;" id="type">
                              <?php
                    ...
                    <div class="col-lg-6">
                          <div class="form-group">
                            <label for="type">Optional Tour Type</label><br>
                            <select name="type" class="select-border" style="width:100%;height:40px;border:1px solid #ececed;" id="type">
