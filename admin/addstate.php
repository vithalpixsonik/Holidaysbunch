...
<head>
  ...
  <title>Holidaysbunch Dashboard</title>
  <!-- plugins:css -->
      ...
      <div class="main-panel">
        <div class="content-wrapper" style="background-color:white">
          ...
          <div class="row card" style="margin-left: 5%;margin-right: 5%">
            ...
            <form style="width: 90%;margin:2% 4%" enctype="multipart/form-data" method="POST" action="addstate.php">
                
            <h3 class="text-center mb-5">Add Place</h3>
              ...
              <div class="row">
                <div class="col-lg-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" style="border: 1px solid #b9b9b9;border-radius: 0" placeholder="Place name" id="name" required>
                      </div>
                </div>
                <div class="col-lg-5">
                    <div class="form-group">
              ...
              <br>
              <input type="submit" id="submit" class="btn btn-primary form-control"  name="add-country" value="Add Place">
            </form>
          </div>
