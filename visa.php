...
<br>
    ...
    <div class="section_title mb-20px mt-5 mb-5 text-center">
        <h1 class="mb-5" style="font-size:40px">Countries Visa Details</h1>
            <div class="container">
                <div class="row">
                    ...
                    <?php 
                         ...
                         while($row = $run_pro->fetch_assoc()) {
                             $country=$row['name'];
                             $sql="select DISTINCT country from visa where  country='$country' ";
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="card m-2" style="border-bottom:4px solid black">
                            <a class="" style='float:right' href="visadetails.php?country=<?php echo $row['name'] ?>">
                                <h3 class="pl-5 pr-5 pt-5 pb-1  text-center" style="font-size:28px;font-weight:500"><?php echo $country ?> </h3>
                                <h5 class="text-center pt-5 pb-4" style="font-size:15px">Starting From ₹ <?php echo $cost ?> </h5>
                            </a> 
                        </div>
                    </div>
